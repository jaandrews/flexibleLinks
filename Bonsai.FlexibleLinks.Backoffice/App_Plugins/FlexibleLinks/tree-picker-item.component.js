(function () {
    angular.module('umbraco')
        .component('treePickerItem', {
            ...
            template: `
                <div class="link" ng-class="{selected: vm.item.selected}" ng-style="{ paddingLeft: 20 * vm.depth + 'px'}">
            ...
            `,
            controller: TreePickerItemController,
            controllerAs: 'vm'
        });

    TreePickerItemController.$inject = []
    function TreePickerItemController() {
        var vm = this;
